package com.steve1316.genshin_inventory_scanner_android;
...
public class MainActivity extends ReactActivity {
    public static final String loggerTag = "[GIS]";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AppUpdater(this)
                ...
                .setUpdateXML("https://raw.githubusercontent.com/steve1316/genshin-inventory-scanner-android/main/android/app/update.xml")
                .start();
    ...
    protected String getMainComponentName() {
        return "Genshin Inventory Scanner";
    }
